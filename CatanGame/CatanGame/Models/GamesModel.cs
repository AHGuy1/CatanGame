...
namespace CatanGame.Models
{
    public class GamesModel
    {
        ...
        public ObservableCollection<TurnTime> TurnTimes { get; set; } = [new TurnTime(20), new TurnTime(30), new TurnTime(45), new TurnTime(60), new TurnTime(75), new TurnTime(90), new TurnTime(120), new TurnTime(180), new TurnTime(300)];
